...
type BlockTranserClient interface {
	// 由发送方调用函数，接收方实现函数
	TransBlock(ctx context.Context, in *Block, opts ...grpc.CallOption) (*StatusA, error)
}
...
func (c *blockTranserClient) TransBlock(ctx context.Context, in *Block, opts ...grpc.CallOption) (*StatusA, error) {
	out := new(StatusA)
...
type BlockTranserServer interface {
	// 由发送方调用函数，接收方实现函数
	TransBlock(context.Context, *Block) (*StatusA, error)
...
func (UnimplementedBlockTranserServer) TransBlock(context.Context, *Block) (*StatusA, error) {
...
type MsgTranserClient interface {
	TransMsg(ctx context.Context, in *Msg, opts ...grpc.CallOption) (*StatusA, error)
	// dht调用，orderer实现
	LoadConfig(ctx context.Context, in *StatusA, opts ...grpc.CallOption) (*Config, error)
}
...
func (c *msgTranserClient) TransMsg(ctx context.Context, in *Msg, opts ...grpc.CallOption) (*StatusA, error) {
	out := new(StatusA)
...
func (c *msgTranserClient) LoadConfig(ctx context.Context, in *StatusA, opts ...grpc.CallOption) (*Config, error) {
	out := new(Config)
...
type MsgTranserServer interface {
	TransMsg(context.Context, *Msg) (*StatusA, error)
	// dht调用，orderer实现
	LoadConfig(context.Context, *StatusA) (*Config, error)
...
func (UnimplementedMsgTranserServer) TransMsg(context.Context, *Msg) (*StatusA, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TransMsg not implemented")
}
func (UnimplementedMsgTranserServer) LoadConfig(context.Context, *StatusA) (*Config, error) {
...
func _MsgTranser_LoadConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgTranserServer).LoadConfig(ctx, req.(*StatusA))
	}
	return interceptor(ctx, in, info, handler)
}
